  ...
  return (
    <div className="App">
      ...
      <h1>
        ...
        <input onChange={(e) => setOwner(e.target.value)} placeholder='Insert your wallet address'></input>
        <input onChange={(e) => setContractAddress(e.target.value)} placeholder='Insert NFT address (optional)'></input>
